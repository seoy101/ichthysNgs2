 ...
 */
  ...
  function getHtml(obj){
    $.ajax({
      url:'http://localhost:9000/views/'+obj.exe,
      type:'GET',
      async:'false',
...
$(document).ready(function () {
  ...
  try {
   ...
   $("#finish-button").click(function(){
     ...
     $('.job-list-table').append("<tr id='"+conf.jobName+"'><td id='user-id'>"+conf.uId+"</td><td id='job-name'>"+conf.jobName+"</td>"
         + "<td id='job-type'>"+conf.jobType+"</td><td id='parent-info'>"+conf.parentInfo+"</td>"
         + "<td id='status'>FileUploading<div class='fileloader'></div></td><td id='date'>"+"??"+"</td><td><button type='button' class='btn btn-info'>View Result</button></td></tr>");
